  ...
  if (iDia < 1 || iDia > 31) {
    ...
    if (iDia > 30) {
      datavalida = 0;
             ...
             (iAno % 4 == 00 && iAno % 100 != 0 && iAno % 400 == 0)) {
    if (iMes == 2) {
      if (iDia > 29) {
        datavalida = 0;
      }
...
int q2(char *datainicial, char *datafinal, int *qtdDias, int *qtdMeses,
  ...
  int nDias = 0, nMeses = 0, nAnos = 0, inDia = 0, inMes = 0, inAno = 0,
      finDia = 0, finMes = 0, finAno = 0;
  ...
  if (inMes == 1 || inMes == 3 || inMes == 5 || inMes == 7 || inMes == 8 ||
      inMes == 10 || inMes == 12) {
    nDias += 31 - inDia;
    nDias += finDia;
  }
  ...
  if (inMes == 2) {
    if ((inAno % 4 == 0 && inAno % 100 != 0) ||
        (inAno % 4 == 0 && inAno % 100 != 0 && inAno % 400 == 0)) {
      nDias += 29 - inDia;
      nDias += finDia;
    } else {
      nDias += 28 - inDia;
