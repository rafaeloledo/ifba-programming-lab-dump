...
struct disc {
  char nome[TAM2], semestre[TAM3], professor[TAM2], alunos[TAM2][TAM2],
      codigo[TAM3];
} disciplina[TAM];
...
void CadastroAluno(char nome[TAM2], char sexo[TAM3], char dataNascimento[TAM3],
                   char cpf[TAM3], int matricula) {
  setlocale(LC_ALL, "Portuguese");
  int i = 0, cont = 0, cont1 = 0, cont2 = 0, cont3 = 0, cont4 = 0, cont5 = 0,
      dia, mes, ano, contcpf = 0;
...
void CadastroProfessor(char nome[TAM2], char sexo[TAM3],
                       char dataNascimento[TAM3], char cpf[TAM3],
                       int matricula) {
  setlocale(LC_ALL, "Portuguese");
  int dia, mes, ano;
  int i = 0;
...
void CadastroDisciplina(char nome[TAM2], char semestre[TAM3],
                        char professor[TAM2], char alunos[TAM2][TAM2],
                        char codigo[TAM3]) {
  setlocale(LC_ALL, "Portuguese");
