...
// v 07:58 12/06/2021
/* 13) Faça uma função recursiva que receba um número inteiro positivo N e
...
tipo1 main() {
  ...
  do {
    printf("Digite um número inteiro n para imprimí-lo em ordem decrescente: ");
    scanf(c1, &n);
    tam = funcao1(n);
    int *num1 = funcao2(n, tam);
    printf("Número em ordem decrescente: \n");
    funcao3(num1, tam);
    printf("\n");
    n = 0, tam = 0, num = 0;
